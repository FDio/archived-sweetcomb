...
static const char * const SC_PLUGIN_NAME="sc_if";
...
sr_plugin_init_cb (sr_session_ctx_t *session, void **private_ctx)
{
	...
	//INTERFACE
	SC_SETUP_RPC_EVT_HANDLER(sc_interface_add_del_address_events);
	SC_SETUP_RPC_EVT_HANDLER(sc_interface_set_flags_events);
